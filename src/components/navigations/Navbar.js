...
function Navbar(){
    ...
    // Funcion para detectar scroll y asignar clases si esta al inicio
            ...
            <div className="px-4 sm:px-6">
                <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">
                        ...
                        <NavLink to='/Carrer' className="text-lg inline-flex font-medium leading-6 text-gray-900 border-b-2 border-white hover:border-orange-500 transition duration-300 ease-in-out mx-4">Carrer</NavLink>
